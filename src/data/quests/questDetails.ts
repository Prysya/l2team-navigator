...
export const QUEST_DETAILS: Record<string, QuestDetail> = {
  ...
  'Covert Business': {
    npc: "Keef Bronze Key's",
    npcId: 30534,
    location: 'Dwarven Village, Дом старейшин',
    startLvl: 10,
    endLvl: 16,
  },
  'Dreaming of the Skies': {
    npc: "Arin Black Anvil's",
    npcId: 30536,
    location: 'Dwarven Village, Дом старейшин',
    startLvl: 11,
    endLvl: 15,
  ...
  "Tarantula's Spider Silk": {
    npc: 'Mion Grocer',
    npcId: 30519,
    location: 'Dwarven Village, Бакалея',
    startLvl: 15,
    endLvl: 21,
  },
  'Traces of Evil': {
    npc: 'Kunai Armor Merchant',
    npcId: 30559,
    location: 'Orc Village, Оружейная лавка',
    startLvl: 15,
    endLvl: 21,
  },
  "Collector's Dream": {
    npc: 'Alshupes',
    npcId: 30222,
    location: 'Elven Village, Площадь',
    startLvl: 15,
    endLvl: 21,
  },
  "Rancher's Plea": {
